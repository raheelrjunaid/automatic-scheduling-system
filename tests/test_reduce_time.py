...
class TestReduceTime(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.day_1 = Day(9, 22, name="day_1")
        self.day_2 = Day(9, 22, name="day_2")
        self.day_3 = Day(9, 22, name="day_3")
        self.day_4 = Day(9, 22, name="day_4")
        ...
        for day_number, day in enumerate(self.days):
            generate_day(self.emps, day, day_number, 1)
